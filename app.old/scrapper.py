...
def parse_feed(xml_content):
    """
    Extracts video IDs and titles from the provided XML feed content.
    Returns a list of tuples containing the ID and the title.
    """
...
def run_scraper():
    ...
    Inserts newly found videos into the database queue.
    """
        ...
        for channel_id, handle in channels:
            ...
            for vid_id, title in entries:
                ...
                if not cursor.fetchone():
                    ...
                    cursor.execute(
                        "INSERT INTO video_queue (video_id, channel_id, channel_handle, title, ai_status) VALUES (?, ?, ?, ?, ?);",
                        (vid_id, channel_id, handle, title, ai_status)
                    )
