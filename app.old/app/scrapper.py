...
Newly discovered videos are inserted with the status "new".
This allows the Ollama gatekeeper script to evaluate them before AI processing.
"""
...
def init_tables_and_get_columns():
    ...
    # The default status is now set to new for the gatekeeper workflow
    cursor.execute("""
        ...
        for channel_id, handle in channels:
            ...
            for vid_id, title in entries:
                ...
                if not cursor.fetchone():
                    ...
                    # Status is strictly set to new here
                    cursor.execute(
                        "INSERT INTO video_queue (video_id, channel_id, channel_handle, title, ai_status) VALUES (?, ?, ?, ?, \"new\");",
